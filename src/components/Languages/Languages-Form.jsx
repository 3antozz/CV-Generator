    ...
    return (
        <form>
            ...
            <div className='field'>
                ...
                <input type="text" id="language" value={item.name} onChange={(event) => onEdit(item.id, {name: event.target.value})} />
            </div>
            <div className='field'>
                <label htmlFor="level">Level</label>
                <input type="text" id="level" value={item.level} onChange={(event) => onEdit(item.id, {level: event.target.value})} />
            </div>
        </>  
            }     
    </form>
